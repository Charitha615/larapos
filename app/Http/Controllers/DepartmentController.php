...
class DepartmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $departments = $departments->orderBy('department_name')->paginate(10);
         $department_list = Department::select('department_id')->orderBy('department_name')->get();
        dd("$department_list");
        $department_list = DB::select('SELECT DISTINCT department_id,department_name,parent_department_id FROM larapos.department ORDER BY department_name');
    ...
    {
        $department_list = Department::select('department_id', 'parent_department_id', 'department_name')->orderBy('department_id','DESC')->get();
    ...
    {
        // dd($request);
        // if($request->parent_department_id == NULL)
        // {
    ...
    public function show(Department $department)
    {
        ...
        $subDepartments = Department::where('parent_department_id',$department->department_id)->get() ?? [];
        return view('department.view')
            ->with('subs',$subDepartments)
    ...
    public function update(DepartmentUpdateRequest $request, Department $department)
    {
        ...
        if (!$department->save()) {
            return redirect()->back()->with('error', 'Sorry, there\'s a problem while updating department.');
        }
