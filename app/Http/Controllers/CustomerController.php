...
class CustomerController extends Controller
{
    ...
    public function store(CustomerStoreRequest $request)
    {
        ...
        if (!$customer) {
            return redirect()->back()->with('error', 'Sorry, there\'s a problem while creating customer.');
        }
    ...
    public function update(Request $request, Customer $customer)
    {
        ...
        if (!$customer->save()) {
            return redirect()->back()->with('error', 'Sorry, there\'s a problem while updating customer.');
        }
