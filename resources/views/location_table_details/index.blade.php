        ...
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('location_table_details.edit', $location_table_details->location_table_detail_id) }}" class="btn btn-link"><i class="fas fa-edit"></i></a>
                        <button class="btn btn-link btn-delete" data-url="{{ route('location_table_details.destroy', $location_table_details->location_table_detail_id) }}"><i class="fas fa-trash"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
