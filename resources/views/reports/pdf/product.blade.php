...
<table class="items" width="100%" style="font-size: 8pt; border-collapse: collapse;">
    <tr>
        <td width="12%"><u>PLU BULK</u></td>
        <td width="10%"><u>PLU</u></td>
        <td width="20%" ><u>DESC</u></td>
        <td width="15%" ><u>DEPT</u></td>
        <td width="15%" ><u>Sub DEPT</u></td>
        <td width="20%" ><u>REGULAR VISITOR</u></td>
        <td width="15%" ><u>SNACK MENU</u></td>
    </tr>
    @foreach($items as $item)
        <tr>
            <td>{{$item->plu_type_id??0}}</td>
            <td>{{$item->plu_no??0}}</td>
            <td>{{$item->description??0}}</td>
            <td>{{$item->department->department_name??0}}</td>
            <td>{{$item->department->parent->department_name??''}}</td>
            <td>0.00</td>
            <td>0.00</td>
        </tr>
    @endforeach
